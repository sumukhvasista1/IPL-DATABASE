...
# Form implementation generated from reading ui file 'SCOREEVALUATION.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_2.setItemText(1, _translate("Form", "MATCH2"))
        self.comboBox_2.setItemText(2, _translate("Form", "MATCH3"))
        self.comboBox_2.setItemText(3, _translate("Form", "MATCH4"))
        self.comboBox_2.setItemText(4, _translate("Form", "MATCH5"))
        self.comboBox_2.setItemText(5, _translate("Form", "MATCH6"))
